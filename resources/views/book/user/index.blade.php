                                ...
                                <div
                                    ...
                                    <div class=" px-4 py-3 w-72  rounded-xl">
                                        ...
                                        <div class="flex items-center mt-2">
                                            <a href="{{ route('user.showBook', $book) }}" class="bg-sky-600 text-white px-4 py-2 rounded mr-2">View</a>
                                            <a href="{{ route('user.showBook', $book) }}" class="bg-sky-600 text-white px-4 py-2 rounded">Reserve</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
